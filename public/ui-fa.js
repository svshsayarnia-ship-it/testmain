...
var phrases=[
  ...
  [/Inventory\.Stockout/g,"اتمام موجودی انبار"],
  [/Inventory\.LowStock/g,"کاهش موجودی انبار"],
  [/Production\.TargetMissed/g,"عدم تحقق برنامه تولید"],
  [/Maintenance\.AssetFailed/g,"خرابی تجهیز"],
  [/Production\.Downtime/g,"توقف تولید"],
 ...
 [/Authority/g,"سطح اختیار"],
  ...
  [/On Hand\/Reserved\/Available/g,"موجودی واقعی / رزروشده / قابل استفاده"],
  [/Stock Ledger/g,"دفتر گردش موجودی"],
  [/Inventory Tx/g,"تراکنش انبار"],
  [/Production Reservation/g,"رزرو برای تولید"],
  [/Stock Count/g,"شمارش موجودی"],
  [/Min\/Max\/Safety\/ROP/g,"حداقل / حداکثر / موجودی اطمینان / نقطه سفارش"],
  [/Need\/Receipt/g,"نیاز / رسید کالا"],
  [/ROP Check/g,"کنترل نقطه سفارش"],
  [/Existing PR\/PO/g,"درخواست یا سفارش خرید موجود"],
  [/PR\/PO باز/g,"درخواست یا سفارش خرید باز"],
  [/PR باز/g,"درخواست خرید باز"],
  [/PO دیرکرد/g,"سفارش خرید با تأخیر"],
  [/منبع: PR/g,"منبع: درخواست خرید"],
  [/منبع: PO/g,"منبع: سفارش خرید"],
  [/PO و تعهد/g,"سفارش خرید و تعهد"],
  [/On-time Delivery/g,"تحویل به‌موقع"],
  [/Vendor Score/g,"امتیاز تأمین‌کننده"],
  [/Vendor ریسک/g,"ریسک تأمین‌کننده"],
  [/Need \+ Stock Check/g,"نیاز و کنترل موجودی"],
  [/Bid Comparison/g,"مقایسه پیشنهادها"],
  [/Delivery\/Quality\/Price/g,"تحویل / کیفیت / قیمت"],
  [/Invoice Match/g,"تطبیق صورتحساب"],
  [/Business Record Store/g,"مخزن داده‌های عملیاتی"],
  [/Safety Stock/g,"موجودی اطمینان"],
  [/\bSafety\b/g,"موجودی اطمینان"],
  [/\bStockout\b/g,"اتمام موجودی"],
  [/\bLead Time\b/g,"زمان تأمین"],
  [/\bUOM\b/g,"واحد اندازه‌گیری"],
  [/\bGRN\b/g,"رسید انبار"],
  [/\bIssue\b/g,"خروج کالا"],
  [/\bReservation\b/g,"رزرو"],
  [/\bCount\b/g,"شمارش"],
  [/\bVariance\b/g,"مغایرت"],
  [/\bReorder\b/g,"سفارش مجدد"],
  [/\bTransaction\b/g,"تراکنش"],
  [/\bBalance\b/g,"مانده"],
  [/\bStock\b/g,"موجودی"],
  [/\bRequested\b/g,"درخواست‌شده"],
  [/\bDelayed\b/g,"با تأخیر"],
  [/\bIn Transit\b/g,"در مسیر تحویل"],
  [/\bNeed\b/g,"نیاز"],
  [/\bRFQ\b/g,"استعلام قیمت"],
  [/\bQuotation\b/g,"پیشنهاد قیمت"],
  [/\bComparison\b/g,"مقایسه"],
  [/\bDelivery\b/g,"تحویل"],
  [/\bPayment\b/g,"پرداخت"],
  [/\bActioning\b/g,"در حال اقدام"],
  [/\bKernel\b/g,"هسته مدیریت"],
  [/\bState\b/g,"وضعیت مرکزی"],
